...
const NFTImplementation = () => {
  ...
  return (
    <section id='nft-implementation' className='container md:p-16'>
      <div className='max-w-[64rem] mx-auto'>
        <div className='flex items-center flex-col space-y-4 max-w-[39.8rem] mx-auto'>
          <h2
            className={cn(
              titilium.className,
              'text-[3.05188rem] leading-[4rem] md:px-[3.052rem]',
          ...
          <p className={cn(titilium.className, 'text-alice-white/50 leading-5 text-center')}>
            Harnessing the pioneering power of blockchain technology, we present to you a stellar
            leap in the event ticketing domain — <span className='font-semibold'>NFT Tickets</span>.
            Each one, not just a key to access, but a unique, verifiable, and tradable asset,
      ...
      <div className='max-w-[90rem] mx-auto'>
        <div className='max-w-[37.1rem] mx-auto space-y-2'>
          <h2
            className={cn(
              titilium.className,
              'text-[1.95313rem] font-semibold leading-[2.5rem] text-alice-white text-center',
            )}
          >
            Exclusive, Inclusive, and Excitingly Tradeable
          </h2>
          <p className={cn(titilium.className, 'text-alice-white/50 leading-5 text-center')}>
            In our first release, explore 4,000 NFTs, each embodying distinct characteristics and
            functionalities, tailor-made for diverse event experiences.
          </p>
        </div>
        ...
        <div className='flex flex-wrap  items-center justify-center  gap-8 my-8'>
          <CardNFT
            ...
            borderColor={'border-alice-white/8 hover:bg-alice-white/5 duration-150'}
          />
