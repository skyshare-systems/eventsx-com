  ...
  return (
    <div className="flex flex-col items-center max-w-[100px] w-full grow-0">
      <div className="flex flex-col items-center gap-2  w-full">
        <div className={`${className} relative duration-1000`}>
          <h1
            className={cn(
              titilium.className,
              "text-[0.8rem] font-semibold text-alice-white/50"
            )}
          >
            Phase
          </h1>
        ...
        <h1
          className={
            ...
            "text-[2.44125rem] font-semibold text-alice-white")
          }
        >
          {number}
        </h1>
      ...
      <div
        className={`duration-1000 delay-150 ${bgcolor} w-[4px] z-[1] block faded-corners`}
      />
    </div>
  );
};
