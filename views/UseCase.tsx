      ...
      <div className="flex flex-col sm:items-end grow max-w-[90rem] mb-2 w-full px-4 xl:px-0">
        <div className="flex flex-col max-w-[637px] w-full gap-4 ">
          ...
          <p
            className={cn(
              titilium.className,
              "text-base text-alice-white/70 sm:text-right"
            )}
          >
            EventsX isn&rsquo;t just another event platform—it&rsquo;s a
            paradigm shift. It&rsquo;s about reimagining how events are
            envisioned, how they unfold, and how they&rsquo;re remembered.
            Experience inclusivity, innovation, and excellence—all at EventsX.
            The future of events begins here.
          </p>
